...
class UserApiTest extends TestCase
{
    ...
    public function test_index(): void
    {
        ...
        collect($data)->each(fn($user) => $this->assertTrue(in_array($user['id'], $userIds->toArray(), true)));
    }
    ...
    public function test_create(): void
    {
        ...
        $response = $this->json('post', $this->uri, array_merge($dummy->toArray(), ['password' => 'password']));
