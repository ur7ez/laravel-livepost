...
{
    public function test_minus_can_subtract_numbers(): void
    {
        $num1 = 5;
        $num2 = 10;
    ...
    public function test_minus_can_take_in_multiple_numbers(): void
    {
        $num1 = 5;
        $num2 = 10;
        $num3 = 120;
    ...
    public function test_minus_cannot_take_in_string_arguments(): void
    {
    ...
    public function test_minus_cannot_take_in_array_argument(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $result = ArithmeticHelper::minus(["abc"]);
    }

    public function test_minus_cannot_take_in_null_argument(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $result = ArithmeticHelper::minus(null);
    }

    public function test_minus_cannot_take_in_boolean_argument(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $result = ArithmeticHelper::minus(true);
    }

    public function test_minus_cannot_take_in_function_argument(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $result = ArithmeticHelper::minus(fn() => true);
    }

    public function test_minus_needs_at_least_one_argument(): void
    {
        $this->expectException(\InvalidArgumentException::class);
